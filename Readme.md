...
Choose which profile you would like to play on from the drop down. It should look like this. ![image](https://github.com/Arkay-1248/Do-Not-Go-Gentle/blob/main/.github/Screenshot_20230214_033834.png) The difference between the two profiles is very small, however, you **_cannot use the DLAA profile if you have an AMD gpu_**. If you would like to add DLSS(NVIDIA) or FSR(AMD) to the list, use the DLAA profile and disable DLAA in the optional tab.
